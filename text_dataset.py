...
class TextDataset(torch.utils.data.Dataset):
    def __init__(self, path, max_sequence_len=128):
        ...
        #  set the tokenizer by using the AutoTokenizer to get 
        ...
        # Call tokenizer with texts as an argument, setting the arguments
        ...
        # Store the input ids of the tokens to self.tokens and labels from
    ...
    def __getitem__(self, idx):
        # Set the tokens variable to be the tokens at index idx
